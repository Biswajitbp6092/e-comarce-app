...
const CartItems = (props) => {
  ...
  const removeItem = (id) => {
    deleteData(`/api/cart/delete-cart-item/${id}`).then((res) => {
      context.openAlartBox("Sucess", "Product removed form cart");
      context?.getCartItems();
    });
  };
  ...
  return (
    <div className="cartItem w-full py-3 flex items-center gap-4 pb-5 border-b border-[rgba(0,0,0,0.2)]">
      <div className="img w-[15%] h-32 rounded-md overflow-hidden">
            ...
            <>
              <div className="relative">
                <span
                  ...
                  className="flex items-center justify-center bg-[#f1f1f1] text-[12px] font-[600] py-1 px-2 rounded-md cursor-pointer"
                >
                  Ram : {selectedSize} <MdArrowDropDown />
                </span>
            ...
            <>
              <div className="relative">
                <span
                  ...
                  className="flex items-center justify-center bg-[#f1f1f1] text-[12px] font-[600] py-1 px-2 rounded-md cursor-pointer"
                >
                  Weight : {selectedSize} <MdArrowDropDown />
                </span>
