  ...
  return (
    <div className="flex items-center gap-5 animate-pulse py-5">
      <div className="col w-[16%] h-[250px]">
        <div className="flex items-center mb-3 justify-center w-full h-48 bg-gray-200 rounded dark:bg-gray-200">
          <svg
        ...
        <div class="h-2.5 bg-gray-200 rounded-full w-30 mb-2.5"></div>
        <div class="h-2 bg-gray-200 rounded-full max-w-[480px] mb-2.5"></div>
        <div class="h-2 bg-gray-200 rounded-full max-w-[160px] mb-2.5"></div>
